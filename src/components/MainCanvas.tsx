 ...
 */
export default function MainCanvas({ config, layoutResult, template, paper }: MainCanvasProps) {
  // --------------------------------------------------------------------------
  // STATE & REFS
  // --------------------------------------------------------------------------
  ...
  return (
    <main className="flex-1 flex flex-col bg-[#111111] relative overflow-hidden">
      ...
      <div className="h-20 border-b border-gray-800 flex items-center justify-between px-8 shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex flex-col items-center justify-center bg-gray-900 hover:bg-gray-800 border border-gray-700 rounded px-4 py-2 h-full transition-colors">
      ...
      <div className="h-14 border-t border-gray-800 bg-gray-950 flex items-center justify-between px-6 shrink-0 z-10">
        ...
        <div className="flex items-center gap-3 bg-gray-900 border border-gray-800 rounded-lg px-2 py-1">
          ...
          <button className="text-[10px] font-medium text-gray-400 hover:text-white px-2">Fit</button>
          <button className="text-[10px] font-medium text-gray-400 hover:text-white px-2">1:1</button>
        </div>
      </div>
